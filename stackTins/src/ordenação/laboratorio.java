...
public class laboratorio {
    ...
    public static void main(String[] args) {
        String[] grupoCriminoso = {"Pt", "PCC", "ACC", "ZDB", "EDC", "UZC", "ACZ"};
        
        System.out.println("Antes do sorting: " + Arrays.toString(grupoCriminoso));
        mergeSort(grupoCriminoso, 0, grupoCriminoso.length - 1);
        System.out.println("Depois sorting: " + Arrays.toString(grupoCriminoso));
    }
}
